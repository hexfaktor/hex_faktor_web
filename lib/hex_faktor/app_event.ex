defmodule HexFaktor.AppEvent do
  ...
  def log(:rebuild_via_hook, provider, project, branch_name) do
    AppEventLog.create(nil, "project.rebuild_via_hook", %{
                              "provider" => provider,
  ...
  def log(:sign_up, user) do
    AppEventLog.create(user, "user.sign_up", %{})
  end
  def log(:sign_in, user) do
    AppEventLog.create(user, "user.sign_in", %{})
  end
  def log(:sign_out, user) do
    AppEventLog.create(user, "user.sign_out", %{})
  end
end
